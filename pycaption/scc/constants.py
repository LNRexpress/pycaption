...
PAC_BYTES_TO_POSITIONING_MAP = {
    '91': {
        ('40', 'c1', 'c2', '43', 'c4', '45', '46', 'c7', 'c8', '49', '4a', 'cb', '4c', 'cd', 'ce', '4f', 'd0', '51'): (1, 0),  # noqa
        ('e0', '61', '62', 'e3', '64', 'e5', 'e6', '67', '68', 'e9', 'ea', '6b', 'ec', '6d', '6e', 'ef', '70', 'f1'): (2, 0),  # noqa
        ('52', 'd3'): (1, 4),
        ('54', 'd5'): (1, 8),
        ('d6', '57'): (1, 12),
        ('58', 'd9'): (1, 16),
    ...
    '92': {
        ('40', 'c1', 'c2', '43', 'c4', '45', '46', 'c7', 'c8', '49', '4a', 'cb', '4c', 'cd', 'ce', '4f', 'd0', '51'): (3, 0),  # noqa
        ('e0', '61', '62', 'e3', '64', 'e5', 'e6', '67', '68', 'e9', 'ea', '6b', 'ec', '6d', '6e', 'ef', '70', 'f1'): (4, 0),  # noqa
        ('52', 'd3'): (3, 4),
        ('54', 'd5'): (3, 8),
        ('d6', '57'): (3, 12),
        ('58', 'd9'): (3, 16),
    ...
    '15': {
        ('40', 'c1', 'c2', '43', 'c4', '45', '46', 'c7', 'c8', '49', '4a', 'cb', '4c', 'cd', 'ce', '4f', 'd0', '51'): (5, 0),  # noqa
        ('e0', '61', '62', 'e3', '64', 'e5', 'e6', '67', '68', 'e9', 'ea', '6b', 'ec', '6d', '6e', 'ef', '70', 'f1'): (6, 0),  # noqa
        ('52', 'd3'): (5, 4),
        ('54', 'd5'): (5, 8),
        ('d6', '57'): (5, 12),
        ('58', 'd9'): (5, 16),
    ...
    '16': {
        ('40', 'c1', 'c2', '43', 'c4', '45', '46', 'c7', 'c8', '49', '4a', 'cb', '4c', 'cd', 'ce', '4f', 'd0', '51'): (7, 0),  # noqa
        ('e0', '61', '62', 'e3', '64', 'e5', 'e6', '67', '68', 'e9', 'ea', '6b', 'ec', '6d', '6e', 'ef', '70', 'f1'): (8, 0),  # noqa
        ('52', 'd3'): (7, 4),
        ('54', 'd5'): (7, 8),
        ('d6', '57'): (7, 12),
        ('58', 'd9'): (7, 16),
    ...
    '97': {
        ('40', 'c1', 'c2', '43', 'c4', '45', '46', 'c7', 'c8', '49', '4a', 'cb', '4c', 'cd', 'ce', '4f', 'd0', '51'): (9, 0),  # noqa
        ('e0', '61', '62', 'e3', '64', 'e5', 'e6', '67', '68', 'e9', 'ea', '6b', 'ec', '6d', '6e', 'ef', '70', 'f1'): (10, 0),  # noqa
        ('52', 'd3'): (9, 4),
        ('54', 'd5'): (9, 8),
        ('d6', '57'): (9, 12),
        ('58', 'd9'): (9, 16),
    ...
    '10': {
        ('40', 'c1', 'c2', '43', 'c4', '45', '46', 'c7', 'c8', '49', '4a', 'cb', '4c', 'cd', 'ce', '4f', 'd0', '51'): (11, 0),  # noqa
        ('52', 'd3'): (11, 4),
        ('54', 'd5'): (11, 8),
        ('d6', '57'): (11, 12),
        ('58', 'd9'): (11, 16),
    ...
    '13': {
        ('40', 'c1', 'c2', '43', 'c4', '45', '46', 'c7', 'c8', '49', '4a', 'cb', '4c', 'cd', 'ce', '4f', 'd0', '51'): (12, 0),  # noqa
        ('e0', '61', '62', 'e3', '64', 'e5', 'e6', '67', '68', 'e9', 'ea', '6b', 'ec', '6d', '6e', 'ef', '70', 'f1'): (13, 0),  # noqa
        ('52', 'd3'): (12, 4),
        ('54', 'd5'): (12, 8),
        ('d6', '57'): (12, 12),
        ('58', 'd9'): (12, 16),
    ...
    '94': {
        ('40', 'c1', 'c2', '43', 'c4', '45', '46', 'c7', 'c8', '49', '4a', 'cb', '4c', 'cd', 'ce', '4f', 'd0', '51'): (14, 0),  # noqa
        ('e0', '61', '62', 'e3', '64', 'e5', 'e6', '67', '68', 'e9', 'ea', '6b', 'ec', '6d', '6e', 'ef', '70', 'f1'): (15, 0),  # noqa
        ('52', 'd3'): (14, 4),
        ('54', 'd5'): (14, 8),
        ('d6', '57'): (14, 12),
        ('58', 'd9'): (14, 16),
